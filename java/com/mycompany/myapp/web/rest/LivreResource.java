...
public class LivreResource {
    ...
    public ResponseEntity<Livre> updateLivre(@PathVariable(value = "id", required = false) final String id, @RequestBody Livre livre)
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, livre.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<Livre> partialUpdateLivre(
        ...
        return ResponseUtil.wrapOrNotFound(result, HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, livre.getId()));
    }
    ...
    @GetMapping("/livres-non-emprunter")
    public ResponseEntity<List<Livre>> findAllNotBorrowed (){
        return ResponseEntity.ok().body(livreService.findAllNotBorrowed());
    }
}
